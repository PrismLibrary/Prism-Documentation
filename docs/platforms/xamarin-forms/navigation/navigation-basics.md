...
Another common scenario when creating a Xamarin.Forms application is the need to provide a different view based on the device the app is running on, such as Desktop, Phone, Tablet, etc.  
