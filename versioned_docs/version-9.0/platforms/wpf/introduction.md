...
| Topic | Description |
|-------|-------------|
| [Commanding](../../commands/commanding) | Bind actions such as button clicks to your view model |
| [Composite Commands](../../commands/composite-commands) | From parent view model, execute commands in child view models |
| [View Model Injection](../../mvvm/viewmodel-locator) | Setup Prism to automatically inject your view model based on naming conventions |
| [Event Aggregation](../../event-aggregator) | Send messages between components without components knowing about each other |
