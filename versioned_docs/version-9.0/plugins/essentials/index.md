...
The API is generally inspired by a combination of Xamarin/.NET MAUI Essentials and in the case of the [Stores](io/stores.md) is inspired by one of our favorite libraries [Shiny.NET](https://shinylib.net).
