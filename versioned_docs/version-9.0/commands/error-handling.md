...
Prism 9 introduced better Error Handling for all Commands including the [AsyncDelegateCommand](async-commands.md). This provides several useful opportunities for app developers.
